 ...
 * @nodep Gtk
 */
if ('/Users/jgm/Development/wxphp-master/tools/macosx_bundle/php/lib/php' != '@'.'include_path'.'@') {
    ini_set('include_path', '/Users/jgm/Development/wxphp-master/tools/macosx_bundle/php/lib/php');
    $raw = false;
} else {
